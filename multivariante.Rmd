...
#### ¿Cómo batean los jugadores por posiciones (SS pueden estar entre los mejores)? {.tabset}
...
#### ¿Cómo impulsan por posiciones (SS no deben estar entre los mejores)? {.tabset}
...
#### ¿Cómo roban los bateadores las bases por posiciones (SS suelen estar entre los mejores)? {.tabset}
